...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Robotqu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名机器人工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.robotqu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'robotqu, 工业机器人,机器人,协作机器人', // 网站关键词 英文逗号隔开

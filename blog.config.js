...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个专注机器人领域的摄影剪辑师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://robotqu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,robotqu,Robot_Qu,工业机器人,机器人', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/505110287?spm_id_from=333.1007.0.0', // B站主页
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '82e51db6-dec2-423a-b7c9-b4ff7ebb3302', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
